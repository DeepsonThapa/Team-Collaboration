...
<script>
  ...
  <!--section2 - courses-->
  <section class="section2" id="menu-details">
  <h3>Courses</h3>
  <div class="courses">
    <ul class="courses-list">
      <li><a href="menulist.html#Breakfast">Breakfast</a></li>
      <li><a href="menulist.html#Lunch">Lunch</a></li>
      <li><a href="menulist.html#Dinner">Dinner</a></li>
    </ul>
  </div>
</section>
...
<section class="section3">
  ...
  <section class="section5">
    ...
    <!--About Us-->
     ...
     <section class="section7" id= "about-us">
