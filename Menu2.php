...
<section class="section1">
  ...
  <div class="menu-section">
    ...
    $sql = "SELECT id, name, description, price, image_path, restaurant_id FROM menu_items2 WHERE category='Breakfast'";
   ...
   <div class="menu-section">
    ...
    // menu items from database for breakfast
    $sql = "SELECT id, name, description, price, image_path, restaurant_id FROM menu_items2 WHERE category='Lunch'";
    $result = $conn->query($sql);
  ...
  <div class="menu-section">
    ...
    // menu items from database for breakfast
    $sql = "SELECT id, name, description, price, image_path, restaurant_id FROM menu_items2 WHERE category='Dinner'";
    $result = $conn->query($sql);
  ...
  <div class="menu-section">
    ...
    // menu items from database for breakfast
    $sql = "SELECT id, name, description, price, image_path, restaurant_id FROM menu_items2 WHERE category='Cold Drinks'";
    $result = $conn->query($sql);
...
function orderNow(itemId, name, description, price, imagePath, restaurantId) {
    fetch('check_login.php')
        ...
        .then(data => {
            if (data.logged_in) {
                //  redirect to details page with the food info
                const url = new URL('Code/Form/order_item.php', window.location.origin);
                url.searchParams.set('id', itemId); // Pass item_id
